...
def generate_launch_description():
    ...
    fsa_models_path = os.path.expanduser("~/bgr_ws/src/src/TracksV0/models")
    ...
    gui_script_path = os.path.expanduser("~/bgr_ws/src/src/TracksV0/tracks/track_gui.py")
    ...
    get_package_share_directory("bgr_description"),
    "config",
    "ekf_publisher.yaml"
    )
